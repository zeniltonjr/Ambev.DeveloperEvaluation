...
public class UserTests
{
    ...
    {
        // Arrange
        var user = TestData.TestData.GenerateValidUser();
    ...
    public void Given_InvalidUserData_When_Validated_Then_ShouldReturnInvalid()
    {
        ...
        var user = new User
        {
            ...
            Password = TestData.TestData.GenerateInvalidPassword(), // Invalid: doesn't meet password requirements
            Email = TestData.TestData.GenerateInvalidEmail(), // Invalid: not a valid email
            Phone = TestData.TestData.GenerateInvalidPhone(), // Invalid: doesn't match pattern
